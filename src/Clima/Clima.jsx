            ...
            <div id='head'>
                ...
                <div id='c_clima'>
                    <div id='clima_report'>
                        ...
                        <div id='max_min'>
                            <div>{this.state.max_temp}<img src={arrow_up} /></div>
                            <div>{this.state.min_temp}<img src={arrow_down} /></div>
                        </div>
                    </div>
                    <div id='feel'>Sensação termica: {this.state.s_ter}</div>
                </div>
                <div id='stat'>
                    {/* porreessaakkkkkkkk */}
